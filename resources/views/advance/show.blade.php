                        ...
                        <div class="col-12 col-sm-4">
                            <div class="info-box bg-light">
                                <div class="info-box-content">
                                    <span class="info-box-text text-center text-muted">Boarder</span>
                                    <span class="info-box-number text-center text-muted mb-0">{{ $advance->user->name }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-4">
                            <div class="info-box bg-light">
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number text-center text-muted mb-0">{{ $advance->user->email }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-4">
                            <div class="info-box bg-light">
                                <div class="info-box-content">
                                    <span class="info-box-text text-center text-muted">Deposit Date</span>
                                    <span class="info-box-number text-center text-muted mb-0">{{ $advance->deposit_date }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-4">
